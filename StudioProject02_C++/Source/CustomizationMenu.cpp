...
SceneCustomizationMenu::SceneCustomizationMenu()
{
}
...
void SceneCustomizationMenu::RenderSkybox() {
...
void SceneCustomizationMenu::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void SceneCustomizationMenu::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
...
void SceneCustomizationMenu::RenderLight() {
...
void SceneCustomizationMenu::Render()
{
...
void SceneCustomizationMenu::Exit()
{
	// Cleanup VBO here
